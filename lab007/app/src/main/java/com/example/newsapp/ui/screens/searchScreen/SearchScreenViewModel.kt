...
class SearchScreenViewModel(private val serverApi: ServerApi) : ViewModel() {
    ...
    fun searchNews(query: String) {
        ...
        viewModelScope.launch {
            try {
                val response = serverApi.searchNews(query, API_KEY)
                ...
                _errorMessage.value = "Failed to search news: ${e.message}"
            } finally {
